...
function preload() {
	...
	// Sounds
	bgm = loadSound('/assets/ogg/little_town_orchestral.ogg');
	step_left_sound = loadSound('/assets/ogg/stepwood_1.wav');
	step_right_sound = loadSound('/assets/ogg/stepwood_2.wav');
	// Import tile data
